 ...
 * Debe ser IDÉNTICA a src/lib/server/pet-fees.ts y a la regla del backend
...
/** Cargo único de aseo por mascotas cuando hay 2 o más (distinto del aseo final de la finca). */
