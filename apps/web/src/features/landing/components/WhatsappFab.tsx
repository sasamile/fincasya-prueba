...
export function WhatsappFab({ className }: { className?: string }) {
  return (
    <a
      ...
      className={cn(
        'flex h-11 w-11 items-center justify-center rounded-full bg-[#25D366] shadow-[0_3px_10px_rgba(37,211,102,0.4)] transition-transform hover:scale-105 active:scale-95',
        className,
      )}
    >
