...
/** Botón flotante de WhatsApp — siempre visible en sitio público, esquina inferior derecha. */
export function WhatsappFab() {
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-[58] flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] shadow-[0_4px_14px_rgba(37,211,102,0.45)] transition-transform hover:scale-105 active:scale-95"
    >
